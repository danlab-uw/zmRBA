...
Equations
Obj, Stoic, RiboCapacityNuc, ProData, Inactive, Nonmodel
;
...
Nonmodel..          v('BIOSYN-PROTMODELED') =l= (1 - %nonmodeled_proteome_allocation%) * (v('BIOSYN-PROTMODELED') + v('BIOSYN-PROTDUMMY'));
