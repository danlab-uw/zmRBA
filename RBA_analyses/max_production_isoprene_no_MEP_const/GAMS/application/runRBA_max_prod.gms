...
v.lo('PROSYN-ZMO0860') = 1.5492283925204008e-08 * %nscale%;
v.up('PROSYN-ZMO0860') = 2.48e-08 * %nscale%;
v.up('PROWASTE-ZMO0860') = 1e3 * %nscale%;
v.lo('PROSYN-ZMO0456') = 6.308558438801126e-08 * %nscale%;
v.up('PROSYN-ZMO0456') = 1e-07 * %nscale%;
v.up('PROWASTE-ZMO0456') = 1e3 * %nscale%;
v.lo('PROSYN-ZMO1818') = 1.245972929389389e-07 * %nscale%;
v.up('PROSYN-ZMO1818') = 2.0e-07 * %nscale%;
v.up('PROWASTE-ZMO1818') = 1e3 * %nscale%;

v.lo('PROSYN-ZMO0220') = 4.3391E-06 * %nscale%;
v.up('PROSYN-ZMO0220') = 8.05832E-06 * %nscale%;
v.up('PROWASTE-ZMO0220') = 1e3 * %nscale%;
v.lo('PROSYN-ZMO1851') = 2.60508E-07 * %nscale%;
v.up('PROSYN-ZMO1851') = 4.83801E-07 * %nscale%;
