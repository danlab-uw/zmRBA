...
v.lo('PROSYN-ZMO0860') = 1.36e-08 * %nscale%;
v.up('PROSYN-ZMO0860') = 2.52e-08 * %nscale%;
v.up('PROWASTE-ZMO0860') = 1e3 * %nscale%;
v.lo('PROSYN-ZMO0456') = 5.52e-08 * %nscale%;
v.up('PROSYN-ZMO0456') = 1.03e-07 * %nscale%;
v.up('PROWASTE-ZMO0456') = 1e3 * %nscale%;
v.lo('PROSYN-ZMO1818') = 1.092e-07 * %nscale%;
v.up('PROSYN-ZMO1818') = 2.03e-07 * %nscale%;
v.up('PROWASTE-ZMO1818') = 1e3 * %nscale%;

v.lo('PROSYN-ZMO0220') = 4.34E-06 * %nscale%;
v.up('PROSYN-ZMO0220') = 8.06E-06 * %nscale%;
v.up('PROWASTE-ZMO0220') = 1e3 * %nscale%;
v.lo('PROSYN-ZMO1851') = 2.61E-07 * %nscale%;
v.up('PROSYN-ZMO1851') = 4.84E-07 * %nscale%;
v.up('PROWASTE-ZMO1851') = 1e3 * %nscale%;

v.lo('PROSYN-ZMO1753') = 1.0857E-06 * %nscale%; 
v.up('PROSYN-ZMO1753') =  2.01631E-06 * %nscale%;
v.up('PROWASTE-ZMO1753') = 1e3 * %nscale%;

v.lo('PROSYN-ZMO1808') = 1.53561E-07 * %nscale%;
v.up('PROSYN-ZMO1808') = 2.85185E-07 * %nscale%;
v.up('PROWASTE-ZMO1808') = 1e3 * %nscale%;
v.lo('PROSYN-ZMO1813') = 1.70369E-07 * %nscale%;
v.up('PROSYN-ZMO1813') = 3.164E-07 * %nscale%;
v.up('PROWASTE-ZMO1813') = 1e3 * %nscale%;
v.lo('PROSYN-ZMO1810') = 2.42871E-07 * %nscale%;
v.up('PROSYN-ZMO1810') = 4.51045E-07 * %nscale%;
v.up('PROWASTE-ZMO1810') = 1e3 * %nscale%;
v.lo('PROSYN-ZMO1811') = 1.07707E-07 * %nscale%;
v.up('PROSYN-ZMO1811') = 2.00027E-07 * %nscale%;
v.up('PROWASTE-ZMO1811') = 1e3 * %nscale%;
v.lo('PROSYN-ZMO1814') = 9.53851E-07 * %nscale%;
v.up('PROSYN-ZMO1814') = 1.77144E-06 * %nscale%;
v.up('PROWASTE-ZMO1814') = 1e3 * %nscale%;
v.lo('PROSYN-ZMO1812') = 3.39444E-07 * %nscale%;
v.up('PROSYN-ZMO1812') = 6.30396E-07 * %nscale%;
v.up('PROWASTE-ZMO1812') = 1e3 * %nscale%;
v.lo('PROSYN-ZMO1809') = 1.30097E-07 * %nscale%;
v.up('PROSYN-ZMO1809') = 2.41608E-07 * %nscale%;
v.up('PROWASTE-ZMO1809') = 1e3 * %nscale%;


*Constraining MEP proteins enzymes 30% above and below experimental value to accound for error in proteomics measurements
v.lo('PROSYN-ZMO1234') = 6.515076638323277e-08 * %nscale%;
v.up('PROSYN-ZMO1234') = 6.51508E-08 * %nscale%;
v.up('PROWASTE-ZMO1234') = 1e3 * %nscale%;
v.lo('PROSYN-ZMO1598') = 9.01129E-07 * %nscale%;
v.up('PROSYN-ZMO1598') = 1.67353E-06 * %nscale%;
v.up('PROWASTE-ZMO1598') = 1e3 * %nscale%;
v.lo('PROSYN-ZMO1150') = 1.40273E-06 * %nscale%;
v.up('PROSYN-ZMO1150') = 2.60507E-06 * %nscale%;
v.up('PROWASTE-ZMO1150') = 1e3 * %nscale%;
v.lo('PROSYN-ZMO1128') = 1.44605E-06 * %nscale%;
v.up('PROSYN-ZMO1128') = 2.68553E-06 * %nscale%;
v.up('PROWASTE-ZMO1128') = 1e3 * %nscale%;
v.lo('PROSYN-ZMO1182') = 3.52439E-07 * %nscale%;
v.up('PROSYN-ZMO1182') = 6.54529E-07 * %nscale%;
v.up('PROWASTE-ZMO1182') = 1e3 * %nscale%;
v.lo('PROSYN-ZMO0180') = 2.90428E-06 * %nscale%;
v.up('PROSYN-ZMO0180') = 5.39367E-06 * %nscale%;
v.up('PROWASTE-ZMO0180') = 1e3 * %nscale%;
v.lo('PROSYN-ZMO0875') = 5.73404E-06 * %nscale%;
v.up('PROSYN-ZMO0875') = 1.06489E-05 * %nscale%;
v.up('PROWASTE-ZMO0875') = 1e3 * %nscale%;
